    ...
    <div class="card mb-4">
      <div class="card-body">
        <form action="<?php echo site_url('admin/surat_masuk/edit') ?>" method="post" enctype="multipart/form-data" >
          ...
          <div class="mb-3">
            <img src="<?= base_url('assets/photo/surat_masuk/'.$surat->image) ?>" height="100px" alt="">
            <br>
            <label for="image">BERKAS SURAT (Photo)</label>
            <input type="file" class="form-control " id="inputGroupFile01" name="image">
            <input class="form-control" type="hidden" name="old_image" value="<?= base_url('assets/photo/surat_masuk/'.$surat->image) ?>" required />
          </div>
