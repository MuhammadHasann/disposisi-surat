      ...
      <div class="card-body">
        <form action="<?php echo site_url('surat_ajuan/edit') ?>" method="post" enctype="multipart/form-data" >
          <div class="mb-3">
            ...
            <input class="form-control" type="text" name="no_surat" value="<?=$surat->no_surat;?>" placeholder="NO SURAT MASUK" readonly required />
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input class="form-control" type="date" name="tgl_surat" value="<?=$surat->tgl_surat;?>" placeholder="TANGGAL SURAT" readonly required />
          </div>
          <div class="mb-3">
            <label >SURAT DARI <code>*</code></label>
            <input class="form-control" type="text" name="surat_from" value="<?=$surat->surat_from;?>" placeholder="SURAT DARI" readonly required />
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input class="form-control" type="date" name="tgl_terima" value="<?=$surat->tgl_surat;?>" placeholder="TANGGAL TERIMA SURAT" readonly required />
          </div>
          <div class="mb-3">
